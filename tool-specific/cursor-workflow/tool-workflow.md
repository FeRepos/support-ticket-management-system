...
**Written from:** `prompt-history.md`, `prompt-history/` phase exports, and the actual codebase — not a hypothetical plan.
...
| Requirements | `tool-specific/cursor-workflow/requirements.md` |
| Cursor rules | `.cursor/rules/project.mdc` |
| Cursor context | `.cursor/context/project-overview.md` |
| Prompt templates | `.cursor/prompts/`, `.cursor/templates/prompt-history.md` |
| Session journey | `tool-specific/cursor-workflow/session-journey.md` |
| Session log | `prompt-history.md`, `prompt-history/` |
